                ...
                <div class="row border-top px-xl-5">
                    <div v-if="responseData" class="col-lg-3 d-none d-lg-block">
                        <a
                            ...
                            style="height: 65px; border: 1px solid black; background-color: white !important; margin-top: -1px; padding: 0 30px"
                        >
                    ...
                    <div class="col-lg-9">
                        ...
                        >
                            ...
                            <img class="img-fluid" src="src/assets/img/banner.jpg" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Rou E-Shop</h3>
