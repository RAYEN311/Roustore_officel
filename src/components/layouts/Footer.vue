    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5 b-bg-color">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-6 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-0">
                    <i class="fa fa-phone-alt text-primary mr-3"></i>{{ settings.phone }}
                </p>
            </div>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-10 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    ...
                    <a target="__blank" class="text-dark font-weight-semi-bold" href="https://github.com/rayen311">Rayen311</a>
                </p>
            </div>
